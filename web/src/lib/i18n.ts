...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    powerOn: "Power On",
    powerOff: "Power Off",
    instanceStartingHint: "Starting up, takes about 3-5 minutes",
    powerOnFirst: "Please power on the instance above first",
    perHour: "/hr",
  ...
  zh: {
    ...
    powerOn: "开机",
    powerOff: "关机",
    instanceStartingHint: "启动中，约需 3-5 分钟",
    powerOnFirst: "请先在上方开启实例",
    perHour: "/时",
    runningFor: "已运行",
    minuteUnit: "分钟",
    instanceStateStopped: "已停止",
    instanceStateStarting: "启动中",
    instanceStateReady: "已就绪",
    instanceStateStopping: "关机中",
    instanceStateFailed: "故障",
    instanceStateUnknown: "未知",
    regenerate: "重新生成",
