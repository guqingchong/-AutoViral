...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    categoryOtherPlaceholder: "e.g. sci-fi, tutorial, travel...",
    resultTitle: "Title",
    ...
    stageRoutingDefault: "Default (stage routing)",
    ...
    powerOnFirst: "Please power on the instance in the AutoDL console first",
    perHour: "/hr",
    instanceStateReady: "Ready",
    instanceStateOffline: "Offline",
    instanceOfflineHint: "Instance is offline. Please power it on in the",
    autodlConsole: "AutoDL Console",
    idleReminder: "Instance has been idle for {n} min. Remember to power it off in the AutoDL console to avoid ongoing charges.",
    regenerate: "Regenerate",
    confirmRegenerateJob: "Resubmit this job with the same params?",
    confirmDeleteAvatar: "Delete this avatar?",
    avatarDeleted: "Avatar deleted.",
    jobDeleted: "Job deleted.",
    jobRegenerated: "Job resubmitted.",
    ...
    scheduleColor: "Color",
    scheduleCreated: "Event created",
    scheduleDeleted: "Event deleted",
  ...
  zh: {
    ...
    categoryOtherPlaceholder: "如：科幻、教程、旅行...",
    resultTitle: "标题",
    ...
    instanceStatus: "实例状态",
    powerOnFirst: "请先到 AutoDL 控制台开机",
    perHour: "/时",
    instanceStateReady: "已就绪",
    instanceStateOffline: "离线",
    instanceOfflineHint: "实例离线，请前往 AutoDL 控制台开机：",
    autodlConsole: "AutoDL 控制台",
    idleReminder: "实例已空闲 {n} 分钟，请记得前往 AutoDL 控制台关机，避免持续计费",
    regenerate: "重新生成",
    confirmRegenerateJob: "按相同参数重新提交该任务？",
    confirmDeleteAvatar: "确定删除该形象？",
    avatarDeleted: "形象已删除",
    jobDeleted: "任务已删除",
    jobRegenerated: "任务已重新提交",
    actualCost: "实际费用",
    statusPending: "待处理",
    statusRunning: "进行中",
    statusFailed: "失败",
