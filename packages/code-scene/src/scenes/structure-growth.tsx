...
export default function makeStructureGrowth(params: StructureGrowthParams) {
  ...
  return makeScene2D("structure-growth", function* (view) {
    ...
    items.forEach((b, i) => {
      ...
      view.add(<Line ref={lines[i]} points={[[centerPos.x, centerPos.y + 80], [pos.x, pos.y - 70]]}
      ...
      view.add(<Txt ref={labels[i]} text={b.label} fontSize={34} fill={theme.subTextColor}
    ...
    if (params.loopArrow !== false) {
      ...
      view.add(<Line ref={loopArrow} points={[[0, lastY + 70], [0, 800], [centerPos.x, centerPos.y + 160]]}
